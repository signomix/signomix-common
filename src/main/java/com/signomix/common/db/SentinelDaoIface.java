...
public interface SentinelDaoIface {
    public static final int ALERT_CONFIG = 1;
    public static final int COMMAND_CONFIG = 2;
    public static final int ANY_CONFIG = 0;
    ...
    public List<SentinelConfig> getOrganizationConfigs(long organizationId, int limit, int offset, int type) throws IotDatabaseException;
    public List<SentinelConfig> getConfigsByDevice(String deviceEui, int limit, int offset, int type) throws IotDatabaseException;
